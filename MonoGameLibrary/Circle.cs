...
public readonly struct Circle : IEquatable<Circle>
{
    ...
    /// <summary>
    /// The length, in pixels, from the center of the circle to the edge.
    /// </summary>
    public readonly int Radius;

    /// <summary>
    /// Gets the location of the center of the circle.
    /// </summary>
    ...
    /// <summary>
    /// Gets a value that indicates whether this circle has a radius of 0 and is located at (0,0).
    /// </summary>
    ...
    /// <summary>
    /// Creates a new circle with the specefied position and radius.
    /// </summary> 
    ...
    /// Creates a new circle with the specefied position and radius.
    /// </summary>
    /// <param name="location">The location of the center of the circle.</param>
    /// <param name="radius">The radius of the circle.</param>
    ...
    /// <summary>
    /// Returns a vlue that indicates whether the specefied circle intersects with this circle.
    /// </summary>
    /// <param name="other">The circle to test for intersection.</param>
    /// <returns>true if the other circle intersect with this circle; otherwise, false.</returns>
    ...
    /// <summary>
    /// Returns a value that indicates whether this circle ans the specified object are equal.
    /// </summary>
    ...
    /// <summary>
    /// Retirns a value that indicates whether ths circle and the specefied circle are equal.
    /// </summary>
