...
public class MouseInfo
{
    ...
    // <summary>
    // Gets or sets the current  x-coordinate of the mouse cursor in screen space.
    // </summary>
    public int X 
    { 
    ...
    // <summary>
    // Gets or sets the current  y-coordinate of the mouse cursor in screen space.
    // </summary>
    public int Y 
    { 
    ...
    // <summary>
    // Gets the difference in the mouse cursor position between the previous and current update cycles.
    // </summary>
    ...
    // <summary>
    // Gets value that indicates if the mouse cursor moved between the previous and current frames.
    // </summary>
    ...
    // <summary>
    // Updates the mouse state information about mouse input.
    // </summary>
    public void Update()
    {
